...
Продажа с ID `104` ссылается на отсутствующего партнёра. Она сохранена в [карантине] и не включена в рабочую историю.
...
В [4_final_app/database.ini] укажите параметры своего сервера:
